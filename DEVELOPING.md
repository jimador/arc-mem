...
See [CLAUDE.md](CLAUDE.md) for project governance, architecture overview, and links to reference codebases.

## Key Files

See "Key Files" section in [CLAUDE.md](CLAUDE.md) for the authoritative file inventory.
