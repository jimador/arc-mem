...
import dev.arcmem.core.assembly.compaction.CompactionDriftEvaluator;
import dev.arcmem.core.assembly.compaction.CompactionResult;
import dev.arcmem.core.assembly.compaction.SummaryResult;
import dev.arcmem.core.assembly.protection.ProtectedContent;
import dev.arcmem.core.assembly.protection.ProtectedContentProvider;
import dev.arcmem.core.assembly.protection.PropositionContentProtector;
import dev.arcmem.core.assembly.protection.MemoryUnitContentProtector;
...
class CompactionTest {
    ...
    @Nested
    @DisplayName("MemoryUnitContentProtector")
    class MemoryUnitContentProtectorTests {

        @Mock
        private ArcMemEngine arcMemEngine;

        private MemoryUnitContentProtector protector;

        @BeforeEach
        void setUp() {
            protector = new MemoryUnitContentProtector(arcMemEngine);
        }

        @Test
        @DisplayName("priority equals memory unit activation score")
        ...
        @Test
        @DisplayName("returns id and text from memory unit")
        ...
        @Test
        @DisplayName("returns multiple protected items for multiple memory units")
