...
public record SimulationScenario(
     ...
     *
     * @param aggressiveness      0.0–1.0, controls how many units to target per turn
    ...
    public record SeedUnit(String text, String authority, int rank) {}
    ...
    public String displayObjective() {
        ...
        if (adversarial) {
            return "Tests unit resilience under adversarial contradiction pressure.";
        }
        return "Tests unit stability and factual consistency under normal play.";
    }
    ...
    public List<String> displayHighlights() {
        ...
        generated.add("Seed units: %d".formatted(seedUnits != null ? seedUnits.size() : 0));
