...
class BenchmarkRenderUtils {
    ...
    static final Map<String, String> METRIC_LABELS = Map.of(
            ...
            "unitAttributionCount", "Attribution",
    ...
    static final Map<String, String> METRIC_DESCRIPTIONS = Map.of(
            ...
            + "excluded.",
            "unitAttributionCount", "Number of distinct ground truth facts that received at least one CONFIRMED verdict, indicating the DM actively referenced them.",
    ...
    static String determineHealth(String metricName, BenchmarkStatistics stats) {
        ...
        return switch (metricName) {
            ...
            case "unitAttributionCount" -> stats.mean() > 0 ? "good" : "warn";
