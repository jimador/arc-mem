 ...
 * <ul>
 *   <li>Survival rate (fact survival from ScoringResult or unit count fallback)</li>
 ...
 *   <li>Attribution accuracy (from ScoringResult unit attribution count)</li>
...
public class DriftSummaryPanel extends VerticalLayout implements SimulationProgressListener {
    ...
    public void showResults(SimulationProgress progress) {
        ...
        this.currentUnitCount = progress.activeUnits() != null ? progress.activeUnits().size() : 0;
        ...
        var survivalRate = scoring != null
                ...
                : (seedUnitCount > 0
                ? (double) currentUnitCount / seedUnitCount * 100.0
                : 100.0);
        ...
        metricsGrid.add(
                ...
                metricCard("Attribution", attributionLabel,
                           scoring != null
                                   ? (scoring.unitAttributionCount() > 0 ? "good" : "warn")
    ...
    /**
     * Set the initial unit count for survival rate calculation.
     */
    public void setSeedUnitCount(int count) {
        this.seedUnitCount = count;
    }
