> **Migrated:** This content has been consolidated into [`docs/dev/design-rationale.md`](dev/design-rationale.md). This file is retained as a transitional pointer and will be removed in a future cleanup.
