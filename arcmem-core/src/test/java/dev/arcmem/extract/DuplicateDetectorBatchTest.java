...
class DuplicateDetectorBatchTest {
    ...
    class CompositeBatch {
        ...
        void emptyListReturnsEmptyMap() {
            ...
            var result = detector.batchIsDuplicate(List.of(), singleUnit("fact"));
        ...
        void allFastPathNoLlmCall() {
            ...
            var result = detector.batchIsDuplicate(List.of("the king is dead"), singleUnit("The king is dead"));
        ...
        @Test
        @DisplayName("no memory units returns all false without LLM call")
        void noUnitsReturnsFalseForAll() {
            var llm = new LlmDuplicateDetector(chatModel, llmCallService);
            var detector = new CompositeDuplicateDetector(fastDetector, llm);
    ...
    class LlmBatch {
        ...
        void llmFailureFallsBackToIndividualCalls() {
            ...
            var result = detector.batchIsDuplicate(List.of("Novel statement"), singleUnit("The king is dead"));
        ...
        void malformedJsonAllUnique() {
            ...
            var result = detector.batchIsDuplicate(List.of("candidate"), singleUnit("fact"));
