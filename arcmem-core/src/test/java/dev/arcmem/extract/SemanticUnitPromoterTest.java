...
class SemanticUnitPromoterTest {
    ...
    void setUp() {
        ...
        var properties = new ArcMemProperties(
                unitConfig, null, null, null, null, null, null, new ArcMemProperties.AssemblyConfig(0, false, dev.arcmem.core.assembly.compliance.EnforcementStrategy.PROMPT_ONLY), null, null, null, null, null, null, null
        );
    ...
    class ConflictPreCheckGate {
        ...
        private SemanticUnitPromoter promoterWithIndex(ConflictIndex index) {
            ...
            var simConfig = new ArcMemProperties.SimConfig("gpt-4.1-mini", 30, 30, 10, true, 4);
            var properties = new ArcMemProperties(
