...
class SemanticUnitPromoterBatchTest {
    ...
    void setUp() {
        ...
        var properties = new ArcMemProperties(
                ...
                new ArcMemProperties.AssemblyConfig(0, false, EnforcementStrategy.PROMPT_ONLY), null, null, null, null, null, null, null, new ArcMemProperties.LlmCallConfig(30, BATCH_MAX_SIZE));
