...
class CompactionValidatorThresholdTest {
    ...
    class ConfigurableThreshold {
        ...
        void defaultThresholdRejectsSummaryWithLowRatio() {
            ...
            var units = List.of(
                    MemoryUnit.withoutTrust("a-1", "The dragon guards the golden ancient treasure",
        ...
        void customThresholdAcceptsSummaryWithModerateRatio() {
            ...
            var losses = CompactionValidator.validate(summary, units, 0.2);
        ...
        void zeroThresholdAcceptsSummaryWithNoMatches() {
            var units = List.of(
                    MemoryUnit.withoutTrust("a-1", "The dragon guards the golden treasure",
                            500, Authority.RELIABLE, false, 0.8, 2)
            );
            var summary = "Completely unrelated text about taverns and inns.";

            var losses = CompactionValidator.validate(summary, units, 0.0);
        ...
        void fullThresholdRequiresAllWords() {
            ...
            var losses = CompactionValidator.validate(summary, units, 1.0);
        ...
        void exactRatioMatchPasses() {
            ...
            var units = List.of(
                    MemoryUnit.withoutTrust("a-1", "The dragon sleeps",
                            500, Authority.RELIABLE, false, 0.8, 2)
            );
