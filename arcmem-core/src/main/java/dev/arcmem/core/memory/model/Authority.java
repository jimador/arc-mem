 ...
 *       requires explicit action (seed units, manual tool call, or approved canonization
 ...
 * A memory unit cannot be promoted above its trust ceiling.
 *
 ...
 *       action (seed units, manual tool call, or approved canonization request) can set
 *       CANON.</li>
 *   <li><strong>A3b</strong>: CANON memory units are immune to automatic demotion (decay, trust
 ...
 *   <li><strong>A3d</strong>: Pinned memory units are immune to automatic demotion. Explicit
 ...
 * Authority is now bidirectional: memory units may be promoted upward or demoted downward
