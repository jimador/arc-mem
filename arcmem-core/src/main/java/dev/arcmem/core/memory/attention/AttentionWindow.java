...
public record AttentionWindow(
    ...
    public AttentionWindow withConflict(Instant eventTime, Duration windowDuration) {
        ...
        return new AttentionWindow(
                updated.unitId(), updated.contextId(),
    ...
    public static AttentionWindow initial(String unitId, String contextId, Instant eventTime) {
        return new AttentionWindow(
                unitId, contextId, 0, 0, 1, eventTime, eventTime, List.of(eventTime)
        );
    }

    public static AttentionWindow initialConflict(String unitId, String contextId, Instant eventTime) {
        return new AttentionWindow(
                unitId, contextId, 1, 0, 1, eventTime, eventTime, List.of(eventTime)
        );
    }

    public static AttentionWindow initialReinforcement(String unitId, String contextId, Instant eventTime) {
        return new AttentionWindow(
                unitId, contextId, 0, 1, 1, eventTime, eventTime, List.of(eventTime)
        );
    }
