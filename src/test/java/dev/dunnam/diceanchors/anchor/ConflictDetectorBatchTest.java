...
class ConflictDetectorBatchTest {
    ...
    class DefaultBatchDetect {
        ...
        void batchDetectDefaultDelegatesPerCandidate() {
            var anchors = List.of(anchor("a1", "The sky is blue"));
            var conflict = new ConflictDetector.Conflict(
                    anchor("a1", "The sky is blue"), "The sky is not blue", 0.9, "negation");

            // Concrete anonymous implementation using the default batchDetect
            ConflictDetector impl = (incomingText, existingAnchors) -> {
            ...
            var result = impl.batchDetect(candidates, anchors);
        ...
        void batchDetectEmptyListReturnsEmptyMap() {
            var anchors = List.of(anchor("a1", "Some fact"));
            ConflictDetector impl = (incomingText, existingAnchors) -> List.of();

            var result = impl.batchDetect(List.of(), anchors);
        ...
        void batchDetectDefaultCallsDetectPerCandidate() {
            var anchors = List.of(anchor("a1", "anchor text"));
            ...
            impl.batchDetect(candidates, anchors);
        ...
        void batchDetectReturnsAllCandidateKeys() {
            ConflictDetector impl = (incomingText, existingAnchors) -> List.of();
            var anchors = List.of(anchor("a1", "some anchor"));
    ...
    class NegationBatchDetect {
        ...
        void batchDetectNegationMatch() {
            var anchors = List.of(anchor("a1", "The king is dead"));
            var candidates = List.of("The king is not dead");

            var result = detector.batchDetect(candidates, anchors);
        ...
        void batchDetectNoConflicts() {
            var anchors = List.of(anchor("a1", "The castle stands tall"));
        ...
        void batchDetectEmptyReturnsEmpty() {
            ...
            var result = detector.batchDetect(List.of(), anchors);
