...
- anchors-reference.jinja — Renders anchors by authority tier (STRICT/MODERATE/WEAK) with RFC 2119 compliance language
- anchors-reference-overhead.jinja — Compact anchor reference for token-budget-constrained scenarios
- dice-anchors.jinja — Main system prompt for chat flow: integrates DICE extraction and anchor compliance framework
...
- system.jinja — D&D Dungeon Master role definition and anchor compliance instructions
- user.jinja — Player turn context and anchor compliance checking framework
...
- evaluator.jinja — LLM prompt for evaluating DM response drift against anchors
