...
/**
 * Unified coordination interface for anchor memory maintenance.
 *
...
public sealed interface MaintenanceStrategy
    ...
    /**
     * Execute a proactive maintenance sweep over the active anchor set.
     * <p>
     * The sweep contract follows the 5-step pattern derived from Sleeping LLM:
     * audit all anchors, refresh rank/authority, consolidate overlaps, prune candidates,
     * validate surviving anchors. The {@link SweepResult} records counters for each step.
     * <p>
