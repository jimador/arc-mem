...
/**
 * OpenAI-compatible logit bias representation derived from anchor constraints.
 * <p>
 ...
 * CANON anchors receive the maximum bias of 100; RELIABLE anchors receive 50.
 ...
 * @param constraintCount number of anchor constraints that contributed to this map
...
public record LogitBiasMap(
    ...
    /** Bias value applied to tokens from CANON anchors (RFC 2119 MUST). */
    public static final int CANON_BIAS = 100;

    /** Bias value applied to tokens from RELIABLE anchors (RFC 2119 SHOULD). */
