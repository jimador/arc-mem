...
The Propositions tab SHALL display only propositions that have NOT been promoted to anchors (rank == 0) for the `"chat"` context, showing text, confidence score, and knowledge status. The list SHALL refresh after each chat turn.
