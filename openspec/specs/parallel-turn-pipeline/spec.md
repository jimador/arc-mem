...
Reinforcement, dormancy lifecycle, anchor state diffing, and compaction SHALL remain sequential and MUST execute only after all parallel branches have joined.
