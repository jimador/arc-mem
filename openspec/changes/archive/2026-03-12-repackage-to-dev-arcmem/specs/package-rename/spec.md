...
- **PKG1**: No Java file SHALL contain `dev.dunnam` in any package declaration or import statement.
- **PKG2**: Git history SHALL be preserved via `git mv` for all moved files.
