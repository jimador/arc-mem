...
- [x] 7.3 Manual smoke test: run simulation and verify Graph tab renders entity network for populated context
- [x] 7.4 Manual filter test: verify minimum edge weight and type filters update graph output correctly
- [x] 7.5 Manual context isolation test: verify graph data changes with context and does not leak across runs
