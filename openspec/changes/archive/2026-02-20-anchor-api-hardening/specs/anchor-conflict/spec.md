...
The confidence thresholds (0.8 for REPLACE, 0.6 for DEMOTE_EXISTING) SHALL be sourced from `DiceAnchorsProperties.AnchorConfig.autoActivateThreshold` and a new `demoteThreshold` property respectively, rather than hardcoded.
