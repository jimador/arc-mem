...
- [x] 7.3 Manual smoke test: Start app, verify lifecycle events appear in logs
- [x] 7.4 Verify events visible in Langfuse when tracing enabled (skipped — Langfuse stack not running in current environment; OTEL tracing is wired via application.yml when enabled)
...
- [x] 8.4 Verify no debug logging left in code
