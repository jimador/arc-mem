# Feature: Working Memory Tiering Core
...
Define this feature at proposal-ready fidelity so `openspec new change working-memory-tiering-core` can produce a strong proposal artifact.
...
2. Priority: MUST.
3. OpenSpec change slug: `working-memory-tiering-core`.
...
1. Requirement: This feature SHALL introduce capability `working-memory-tiering-core` with explicit boundaries.
...
|---------|-------------|-----------------|------------|-----------------|
| R01 | Related research indicates this feature is warranted and scoped for this wave. | `docs/research/` | Medium | Proposal should resolve remaining unknowns explicitly. |
...
`openspec new change working-memory-tiering-core`
