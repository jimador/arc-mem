# Feature: Conflict Detection Calibration Core
...
Define this feature at proposal-ready fidelity so `openspec new change conflict-detection-calibration-core` can produce a strong proposal artifact.
...
3. Why now: sequencing places this feature in wave 1 after dependencies are met.
...
1. Feature dependencies: F01.
2. Priority: MUST.
3. OpenSpec change slug: `conflict-detection-calibration-core`.
...
`conflict-detection-calibration-core`
...
1. Requirement: This feature SHALL introduce capability `conflict-detection-calibration-core` with explicit boundaries.
...
|---------|-------------|-----------------|------------|-----------------|
| R02 | Related research indicates this feature is warranted and scoped for this wave. | `docs/research/` | Medium | Proposal should resolve remaining unknowns explicitly. |
...
`openspec new change conflict-detection-calibration-core`
