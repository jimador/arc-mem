# Feature: Bi-Temporal Validity and Supersession
...
Define this feature at proposal-ready fidelity so `openspec new change bi-temporal-validity-and-supersession` can produce a strong proposal artifact.
...
3. Why now: sequencing places this feature in wave 2 after dependencies are met.
...
2. Priority: SHOULD.
3. OpenSpec change slug: `bi-temporal-validity-and-supersession`.
...
1. Requirement: This feature SHALL introduce capability `bi-temporal-validity-and-supersession` with explicit boundaries.
...
|---------|-------------|-----------------|------------|-----------------|
| R04 | Related research indicates this feature is warranted and scoped for this wave. | `docs/research/` | Medium | Proposal should resolve remaining unknowns explicitly. |
...
`openspec new change bi-temporal-validity-and-supersession`
